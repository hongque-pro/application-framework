...
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.accessFailedCount
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.approved
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.approverId
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.concurrencyStamp
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.email
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.emailConfirmed
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.id
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.language
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.lastClientVersion
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.lastSignInArea
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.lastSignInIp
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.lastSignInPlatform
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.lockoutEnabled
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.lockoutEnd
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.memberId
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.passwordHash
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.phoneNumber
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.phoneNumberConfirmed
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.securityStamp
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.timeCreated
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.timeExpired
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.timeLastActivity
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.timeLastLogin
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.timeZone
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.twoFactorEnabled
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.userName
import com.labijie.application.auth.data.mapper.UserDynamicSqlSupport.User.userType
import com.labijie.application.auth.data.mapper.UserLoginDynamicSqlSupport
...
fun UserMapper.count(completer: CountCompleter) =
    countFrom(this::count, AuthDynamicTableSupport.getTable(User), completer)

fun UserMapper.delete(completer: DeleteCompleter) =
    deleteFrom(this::delete, AuthDynamicTableSupport.getTable(User), completer)
...
fun UserMapper.insert(record: UserRecord, sqlTable: SqlTable? = null) =
    insert(this::insert, record, sqlTable ?: AuthDynamicTableSupport.getTable(User)) {
...
fun UserMapper.insertMultiple(records: Collection<UserRecord>) =
    insertMultiple(this::insertMultiple, records, AuthDynamicTableSupport.getTable(User)) {
        map(id).toProperty("id")
        map(userType).toProperty("userType")
        map(accessFailedCount).toProperty("accessFailedCount")
        map(concurrencyStamp).toProperty("concurrencyStamp")
...
fun UserMapper.insertSelective(record: UserRecord) =
    insert(this::insert, record, AuthDynamicTableSupport.getTable(User)) {
...
fun UserMapper.selectOne(completer: SelectCompleter) =
    selectOne(this::selectOne,
        columnList, AuthDynamicTableSupport.getTable(User), completer)
...
fun UserMapper.update(completer: UpdateCompleter) =
    update(this::update, AuthDynamicTableSupport.getTable(User), completer)
