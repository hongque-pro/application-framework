...
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.accessTokenValidity
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.additionalInformation
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.authorities
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.authorizedGrantTypes
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.autoapprove
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.clientId
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.clientSecret
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.enabled
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.refreshTokenValidity
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.resourceIds
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.scope
import com.labijie.application.auth.data.mapper.OAuth2ClientDetailsDynamicSqlSupport.OAuth2ClientDetails.webServerRedirectUri
...
fun OAuth2ClientDetailsMapper.count(completer: CountCompleter) =
    countFrom(this::count, AuthDynamicTableSupport.getTable(OAuth2ClientDetails), completer)

fun OAuth2ClientDetailsMapper.delete(completer: DeleteCompleter) =
    deleteFrom(this::delete, AuthDynamicTableSupport.getTable(OAuth2ClientDetails), completer)
...
fun OAuth2ClientDetailsMapper.insert(record: OAuth2ClientDetailsRecord) =
    insert(this::insert, record, AuthDynamicTableSupport.getTable(OAuth2ClientDetails)) {
...
fun OAuth2ClientDetailsMapper.insertMultiple(records: Collection<OAuth2ClientDetailsRecord>) =
    insertMultiple(this::insertMultiple, records, AuthDynamicTableSupport.getTable(OAuth2ClientDetails)) {
        map(clientId).toProperty("clientId")
        map(resourceIds).toProperty("resourceIds")
        map(clientSecret).toProperty("clientSecret")
        map(scope).toProperty("scope")
...
fun OAuth2ClientDetailsMapper.selectOne(completer: SelectCompleter) =
    selectOne(this::selectOne,
        columnList, AuthDynamicTableSupport.getTable(OAuth2ClientDetails), completer)
...
fun OAuth2ClientDetailsMapper.update(completer: UpdateCompleter) =
    update(this::update, AuthDynamicTableSupport.getTable(OAuth2ClientDetails), completer)
