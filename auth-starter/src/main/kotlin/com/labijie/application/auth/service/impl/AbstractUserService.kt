...
import com.labijie.application.auth.AuthCacheKeys.getUserCacheKey
...
import com.labijie.application.auth.exception.*
...
abstract class AbstractUserService constructor(
    protected val authServerProperties: AuthServerProperties,
    ...
    private fun fetchAllRoles(): List<RoleRecord> {
        val roles = cacheManager.getOrSet(
            authServerProperties.jdbcTablePrefix.plus(AuthCacheKeys.ALL_ROLES),
    ...
    override fun getUserRoles(userId: Long): List<RoleRecord> {
        ...
        val roleIds = selectList(userRoleMapper::selectMany, listOf(UserRole.roleId), AuthDynamicTableSupport.getTable(UserRole)) {
